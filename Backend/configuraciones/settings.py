...
SECRET_KEY = 'django-insecure-8$a9@&&j+d4#s)jn(ljfn-%_c+^_@v*k35x^z8_hr689&f&tw-'
...
CORS_ALLOWED_ORIGINS = [
    "http://10.30.118.215:8000",
]
CORS_ALLOW_HEDEARS = True
...
JAZZMIN_SETTINGS = {
    ...
    # "icons": {
    #     "producto_app.Categoria": "fas fa-user",
    #     "producto_app.Producto": "producto.png",
    #     "producto_app.Entidad": "entidades.png",
    # },
}
