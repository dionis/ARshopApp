                ...
                children: [
                  ...
                  Padding(
                    ...
                    child: Row(
                      children: [
                        Text(
                          recibirCat(widget.producto.categoria.nombre)
                              .toUpperCase(),
                          style: TextStyle(
                        ...
                        const Spacer(),
                        Text(
                          recibirPrecio(widget.producto.precio.toString()),
                          style: Theme.of(context)
                              .textTheme
                              .bodyMedium!
...
String recibirCat(String nombre) {
  return nombre.length > 6 ? '${nombre.substring(0, 6)}...' : nombre;
}

String recibirPrecio(String nombre) {
